...
public class Settings
{
	...
	public static final String  titleInGame  	     = "Minecraft"; //Заголовок лаунчера после авторизации
        public static final String  basedir	             = "AppData"; //Родительская папка для Minecraft
	...
	public static final String  domain	 	         = "new-sashok164.hol.es";//Домен сайта
	public static final String  siteDir		         = "site";//Папка с файлами лаунчера на сайте
	public static final String  updateFile		     = "http://new-sashok164.hol.es/site/launcher/fix";//Ссылка на обновления лаунчера. Не писать на конце ".exe .jar"!
	public static final String  buyVauncherLink      = "http://plati.ru/"; //Ссылка на страницу покупки ваучеров
	public static final String  iMusicname           = "0001.mp3";
	...
	{
		"voxelaria164, localhost, 25565, 1.6.4",
	};
	...
	public static final String protectionKey	 = "1234567877"; //Ключ защиты сессии. Никому его не говорите.
	public static final String key1              = "1234567891234577"; //16 Character Key Ключ пост запросов
	public static final String key2              = "1234567891234577"; //16 Character Key Ключ пост запросов
	...
	public static final String masterVersion     = "V 0.1"; //Версия лаунчера
